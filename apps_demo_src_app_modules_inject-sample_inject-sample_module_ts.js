...
/* harmony import */ var _taiga_ui_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @taiga-ui/core */ 4109);
/* harmony import */ var _taiga_ui_addon_doc__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @taiga-ui/addon-doc */ 6604);
...
InjectSampleComponent.ɵfac = function InjectSampleComponent_Factory(t) {
  return new (t || InjectSampleComponent)();
};
InjectSampleComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: InjectSampleComponent,
  selectors: [["inject-sample"]],
  decls: 14,
  vars: 1,
  consts: [["header", "@Inject -> inject example"], ["tuiLink", "", "href", "https://stackblitz.com/edit/ts-angular-13-web-container-starter-ozrudz?file=ng-morph-scripts%2Fscript.ts,src%2Fapp%2Fapp.component.html", "target", "_blank"], ["filename", "migration.ts", 3, "code"]],
...
/* harmony import */ var _inject_sample_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./inject-sample.component */ 2727);
...
InjectSampleModule.ɵfac = function InjectSampleModule_Factory(t) {
  return new (t || InjectSampleModule)();
};
InjectSampleModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
  type: InjectSampleModule
});
InjectSampleModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
